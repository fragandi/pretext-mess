...
\date{\today\, $|$ Volume 53, No.\@ 1  \line(1,0){500}}
...
\begin{center}
\includegraphics[scale=0.52]{MSCS Open House Invitation (2).png}
\end{center}
...
On Thursday, September 26 at 4:30 pm in TOH 280, the MSCS Department will be hosting this annual event. Using the Olympics as a theme, the MSCS faculty will talk about the many things that make our department special – like classes, research opportunities, and more. Additionally, members from our many clubs and organizations will tell you about opportunities to socialize with your fellow MSCSers and work together to enhance your MSCS bonafide. After the presentations, there will be time for great food, great conversations, and games. GO FOR THE GOLD WITH MSCS! 
...
\includegraphics[scale=0.27]{images/CS COMMUNITY EVENT.png}
\end{center}
    \begin{center}
...
\noindent{To submit an article, event, or anything else for publication in the Mess, email messeditor@stolaf.edu, or wilson45@stolaf.edu; visit \href{https://wp.stolaf.edu/mscs/mscs-mess/}{http://wp.stolaf.edu/mscs/mscs-mess/} for a digital archive of previous MSCS Mess issues.}}\\
	
\hfill Peter Wilson, Editor
	
\hfill Daniel Stoertz, Faculty Adviser
